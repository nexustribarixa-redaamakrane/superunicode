...
static const uint8_t k_malformed[][8] = {
    ...
    { 0xFC, 0x84, 0x80, 0x80, 0x80, 0x80 },  /* overlong 6-byte           */
    { 0xF8, 0x88, 0x80, 0x80, 0x80 },        /* needs 6-byte framing     */
...
static void test_reserved_stream_rejection(void) {
    static const uint8_t reserved_streams[][8] = {
        { 0xFD, 0xBF, 0xBF, 0xBF, 0xBC, 0xB0 }, /* 0x7FFFFFF0 (trap min) */
        { 0xFD, 0xBF, 0xBF, 0xBF, 0xBC, 0xBE }, /* 0x7FFFFFFE (trap max) */
